...
function addPokeToList(e, o, n) {
    ...
    var r = n.name;
    null !== n.IV && (r += " (" + n.IV + "%)"), a.querySelector("img.pokemon-image").src = "images/" + n.name.replace(/[^\w]/g, "").toLowerCase() + ".png", a.querySelector("p.title").innerText = r, a.querySelector("p.coords").innerText = n.lat + ", " + n.lon, Tipped.create(a.querySelector("p.coords"), "Copied!", {
        position: "topleft",
        showOn: "click",
        showDelay: 0
    });
...
function changeFilter(e) {
    ...
    for (var o = document.getElementsByClassName("poke"), n = 0; n < o.length; n++) {
        var a = $(o[n]), t = a.find("p.title")[0].innerText.indexOf("%") > -1, r = t ? parseInt(a.find("p.title")[0].innerText.match(/\(([^)%]+)%\)/)[1]) : 0;
